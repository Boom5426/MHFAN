...
parser.add_argument('--eval_dataset', type=str, default='BCD_test', help='choice eval dataset')
args = parser.parse_args()

args.eval_dataset == 'BCD_test'

if args.eval_dataset == 'BCD_val':
    gt_file = './gt_file/BCD_val_gt.txt' 
    pred_file = './pred_file/UNet_GPA.txt'
    id_std = [i for i in range(1, 401, 1)]

elif args.eval_dataset == 'BCD_test':
    gt_file = './gt_file/BCD_test_gt.txt'
    pred_file = './A_localization.txt'
    id_std = [i for i in range(1, 401, 1)]
...
def location_main(pred_file, gt_file):
    ...
    for i_sample in range(1, cell_num+1):
        # print("process the", i_sample, ", total:400")
        # init               
